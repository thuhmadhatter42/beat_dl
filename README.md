...
- Only one analyzer is installed. librosa is used only on Macs where Essentia has no build; deps.sh also repairs a numba/numpy mismatch that would break librosa's import
